...
const Home = () => {
  ...
  async function avaxTweet() {
    ...
    let options = {
      contractAddress: "0x199293EF6a36670327F5cb8cFb7C96F856c50a42",
          ...
          <div className="tweetBox">
            ...
            <div className="imgOrTweet">
              ...
              <div className="tweetOptions">
                ...
                <div className="tweet" onClick={avaxTweet} style={{ backgroundColor: "#E84142" }}>
                  <Icon fill="#ffffff" size={20} svg="avax" />
                </div>
              </div>
            </div>
          </div>
